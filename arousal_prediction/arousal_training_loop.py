...
BATCH_SIZE = 16
EPOCHS = 15
LEARNING_RATE = 15e-06
EPSILON = 1e-8
WEIGHT_DECAY = 0.01

model_dir = "sdadas/polish-roberta-base-v2"
save_dir = 'arousal_prediction/output_model/arousal_model.pth'
...
############### DATASET LOADING ###############
train_df = pd.read_csv('arousal_prediction/data/train_data.csv')
val_df = pd.read_csv('arousal_prediction/data/val_data.csv')
