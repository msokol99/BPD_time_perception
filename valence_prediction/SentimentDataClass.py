...
class SentimentData(Dataset):
    ...
    particularly focusing on handling the sentiment associated with the valence dimension in the input data.

    Parameters:
    - dataframe (pandas.DataFrame): The data frame containing the text data and their corresponding sentiment labels.
      The dataframe is expected to have at two columns: 'sentence' for the text and 'valence' for the sentiment labels.
    ...
    def __init__(self, dataframe, tokenizer, max_len):
        ...
        Parameters:
        - dataframe (pandas.DataFrame): The dataset containing sentences and their corresponding valence labels.
        ...
        self.targets = dataframe['valence'].values.astype(int)
